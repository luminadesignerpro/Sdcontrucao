    ...
    <div style={wrapperStyle}>
      ...
      <div style={{ background: "#0B1522", border: "1px solid #1E3350", borderRadius: "10px", padding: "14px", marginBottom: "18px" }}>
        ...
        <div style={{ display: "flex", gap: "8px" }}>
          ...
          />
          <button onClick={handleAddFuncao} style={secondaryBtn}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
        {funcionarios.map((f) => (
          <div key={f.id} style={rowStyle}>
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              <button onClick={() => openEdit(f)} style={iconBtn}><Pencil size={14} /></button>
              <button onClick={() => removeFuncionario(f.id)} style={{ ...iconBtn, borderColor: "#B0555A", color: "#F2A0A5" }}><Trash2 size={14} /></button>
            </div>
          </div>
        ))}
      </div>
      ...
      {showForm && (
        <div style={modalOverlay} onClick={() => setShowForm(false)}>
          <div onClick={(e) => e.stopPropagation()} style={modalBox}>
            ...
            <button onClick={saveFuncionario} style={{ ...primaryBtn, width: "100%", justifyContent: "center", marginTop: "8px" }}>
              Salvar
            </button>
          </div>
        </div>
